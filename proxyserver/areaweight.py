...
def cal_area_value(x, y, w, h):
    ...
    every_area_value = [[1, 1, 0.1 / 28], [1, 2, 0.1 / 28], [1, 3, 0.1 / 28], [1, 4, 0.1 / 28], [1, 5, 0.1 / 28],
                        [1, 6, 0.1 / 28], [1, 7, 0.1 / 28], [1, 8, 0.1 / 28],
                        [2, 1, 0.1 / 28], [2, 2, 0.2 / 20], [2, 3, 0.2 / 20], [2, 4, 0.2 / 20], [2, 5, 0.2 / 20],
                        [2, 6, 0.2 / 20], [2, 7, 0.2 / 20], [2, 8, 0.1 / 28],
                        [3, 1, 0.1 / 28], [3, 2, 0.2 / 20], [3, 3, 0.3 / 12], [3, 4, 0.3 / 12], [3, 5, 0.3 / 12],
                        [3, 6, 0.3 / 12], [3, 7, 0.2 / 20], [3, 8, 0.1 / 28],
                        [4, 1, 0.1 / 28], [4, 2, 0.2 / 20], [4, 3, 0.3 / 12], [4, 4, 0.4 / 4], [4, 5, 0.4 / 4],
                        [4, 6, 0.3 / 12], [4, 7, 0.2 / 20], [4, 8, 0.1 / 28],
                        [5, 1, 0.1 / 28], [5, 2, 0.2 / 20], [5, 3, 0.3 / 12], [5, 4, 0.4 / 4], [5, 5, 0.4 / 4],
                        [5, 6, 0.3 / 12], [5, 7, 0.2 / 20], [5, 8, 0.1 / 28],
                        [6, 1, 0.1 / 28], [6, 2, 0.2 / 20], [6, 3, 0.3 / 12], [6, 4, 0.3 / 12], [6, 5, 0.3 / 12],
                        [6, 6, 0.3 / 12], [6, 7, 0.2 / 20], [6, 8, 0.1 / 28],
                        [7, 1, 0.1 / 28], [7, 2, 0.2 / 20], [7, 3, 0.2 / 20], [7, 4, 0.2 / 20], [7, 5, 0.2 / 20],
                        [7, 6, 0.2 / 20], [7, 7, 0.2 / 20], [7, 8, 0.1 / 28],
                        [8, 1, 0.1 / 28], [8, 2, 0.1 / 28], [8, 3, 0.1 / 28], [8, 4, 0.1 / 28], [8, 5, 0.1 / 28],
                        [8, 6, 0.1 / 28], [8, 7, 0.1 / 28], [8, 8, 0.1 / 28],
                        ]
    center_value = 0
